package com.androidcodelibs.common.adapter;
...
import com.androidcodelibs.basemodule.R;
...
public class SamplesAdapter extends RecyclerView.Adapter<SamplesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int position) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_sample_list, viewGroup, false);
