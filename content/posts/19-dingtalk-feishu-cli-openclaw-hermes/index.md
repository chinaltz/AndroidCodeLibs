...
| 企业微信 | `wecom-cli` | Rust | MIT | 消息、文档、智能表格、会议、待办、日程、通讯录 |
...
## 企业微信 wecom-cli：聊天、客户和办公入口更近

企业微信的开源项目叫 **wecom-cli**。
...
日常沟通主要在企业微信，希望从群聊、会议和待办开始尝试 AI 自动化的小团队。
...
- **办公 CLI**：解决“AI 用什么方式进入钉钉、飞书或企业微信执行操作”
...
- [企业微信 wecom-cli 官方仓库](https://github.com/WecomTeam/wecom-cli)
