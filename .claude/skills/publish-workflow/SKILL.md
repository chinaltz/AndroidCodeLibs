...
- **发布就绪**：配图齐、审完后执行 `npm run convert -- content/posts/[slug]`（生成 `index.html` + `.docx`，本地 `./images/` 嵌图）
...
- [ ] 是否已通过敏感词检查（翻墙/Clash/VPN/科学上网/梯子等词已替换或删除）？
- [ ] 文章末尾是否无引流文案、无平台操作说明、无「你需要/操作」引流表格？
- [ ] 标题是否吸引目标读者？
