package com.androidcodelibs.appcode.home.model;
    ...
    public static List<SampleModel> getDatas(int dataType) {
        ...
        switch (dataType) {
            ...
            case 0:
                ...
                SampleModel sampleModel5 = new SampleModel("一些进度条", R.mipmap.ui_loading);
                ...
                SampleModel sampleModel8 = new SampleModel("动画", R.mipmap.ui_keyboard);
