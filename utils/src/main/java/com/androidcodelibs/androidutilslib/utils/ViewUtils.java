...
import com.androidcodelibs.androidutilslib.view.refresh.ALListViewFooter;
import com.androidcodelibs.androidutilslib.view.refresh.ALListViewHeader;
...
public class ViewUtils {
    ...
    public static boolean isNeedScale(View view) {
        if (view instanceof ALListViewHeader) {
            return false;
        }

        if (view instanceof ALListViewFooter) {
            return false;
        }
        return true;
    }
    ...
    public static void setViewSize(View view, int widthPixels, int heightPixels) {
        ...
        if (params == null) {
            LogUtils.e(ViewUtils.class, "setViewSize出错,如果是代码new出来的View，需要设置一个适合的LayoutParams");
            return;
        }
