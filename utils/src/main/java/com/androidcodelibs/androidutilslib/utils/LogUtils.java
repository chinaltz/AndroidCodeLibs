...
public final class LogUtils {
    ...
    public static void v(Context context, final Object... contents) {
    ...
    public static void d(Context context, final Object... contents) {
        String tag = context.getClass().getSimpleName();
        log(D, tag, contents);
    }
    ...
    public static void i(Context context, final Object... contents) {
        log(I, context.getClass().getSimpleName(), contents);
    }
    ...
    public static void w(Context context, final Object... contents) {
        log(W, context.getClass().getSimpleName(), contents);
    }
    ...
    public static void e(Context context, final Object... contents) {
        log(E, context.getClass().getSimpleName(), contents);
    }
    ...
    public static void a(Context context, final Object... contents) {
        log(A, context.getClass().getSimpleName(), contents);
    }
    ...
    public static void file(Context context, final Object content) {
        log(FILE | D, context.getClass().getSimpleName(), content);
    }
    ...
    public static void json(Context context, final String content) {
        log(JSON | D, context.getClass().getSimpleName(), content);
    }
    ...
    public static void xml(Context context, final String content) {
        log(XML | D, context.getClass().getSimpleName(), content);
    }
