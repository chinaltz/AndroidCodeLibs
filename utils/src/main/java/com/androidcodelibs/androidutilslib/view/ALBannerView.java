...
import com.androidcodelibs.androidutilslib.app.adapter.ViewPagerAdapter;
import com.androidcodelibs.androidutilslib.view.listener.ALOnItemClickListener;
import com.androidcodelibs.androidutilslib.view.listener.ALOnPositionChangedListener;
import com.androidcodelibs.androidutilslib.view.listener.ALOnTouchListener;
 ...
 * Info 可播放显示的View
 */
public class ALBannerView extends LinearLayout {
     ...
     * 内部的ViewPager.
     */
    private ALInnerViewPager viewPager;
     ...
     * 点击.
     */
    private ALOnItemClickListener mOnItemClickListener;

    /**
     * 改变.
     */
    private ALOnPositionChangedListener mChangeListener;

    /**
     * 滚动.
     */
    private ALOnPositionChangedListener mScrolledListener;

    /**
     * 触摸.
     */
    private ALOnTouchListener mOnTouchListener;
     ...
     */
    public ALBannerView(Context context) {
        super(context);
        initView(context);
    }

    /**
     * 从xml初始化的ALBannerView
     *
     * @param context the context
     * @param attrs   the attrs
     */
    public ALBannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    public void initView(Context context) {
        ...
        viewPager = new ALInnerViewPager(context);
        ...
        viewPagerAdapter = new ViewPagerAdapter(context, mViewList);
     ...
     */
    public void setOnPageChangeListener(ALOnPositionChangedListener onChangeListener) {
     ...
     */
    public void setOnPageScrolledListener(ALOnPositionChangedListener onScrollListener) {
     ...
     */
    public void setOnTouchListener(ALOnTouchListener onTouchListener) {
