 ...
 */
public class ALListViewFooter extends LinearLayout {
	 ...
	 */
	public ALListViewFooter(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 */
	public ALListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
